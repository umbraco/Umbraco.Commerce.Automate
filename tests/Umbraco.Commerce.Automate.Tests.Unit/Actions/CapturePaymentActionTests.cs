...
public class CapturePaymentActionTests
{
    ...
    public CapturePaymentActionTests()
    {
        _storeAuthorizer
    ...
    {
        var result = await ActionTestHarness.For<CapturePaymentAction>()
            ...
            .WithSettings(new CapturePaymentSettings { OrderId = "not-a-guid" })
            .ExecuteAsync();
